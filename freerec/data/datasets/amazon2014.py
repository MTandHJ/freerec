...
class Amazon2014Sports_550_LOU(NextItemRecDataSet):
    r"""
    Settings
    --------
    kcore4user: 5
    ...
    | #User | #Item | #Interactions | #Train | #Valid | #Test |        Density         |
    +-------+-------+---------------+--------+--------+-------+------------------------+
    | 35598 | 18357 |     296337    | 225141 | 35598  | 35598 | 0.00045348045456958995 |
    +-------+-------+---------------+--------+--------+-------+------------------------+
    """


class Amazon2014Sports_500_LOU(NextItemRecDataSet):
    r"""
    Settings
    --------
    kcore4user: 5
    ...
    | #User | #Item  | #Interactions | #Train | #Valid | #Test |        Density        |
    +-------+--------+---------------+--------+--------+-------+-----------------------+
    | 84368 | 194715 |     717464    | 548728 | 84368  | 84368 | 4.367399816463338e-05 |
    +-------+--------+---------------+--------+--------+-------+-----------------------+
    """
