...
_mock_packages = [
    ...
    'torch.utils', 'torch.utils.data', 'torch.utils.data.graph_settings',
    'torch.utils.data.datapipes', 'torch.utils.data.datapipes.datapipe',
    'torch.utils.tensorboard', 'torch.backends', 'torch.backends.cudnn',
    'torchdata', 'torchdata.datapipes', 'torchdata.datapipes.iter',
    'torchdata.dataloader2', 'torchdata.dataloader2.reading_service',
    'torch_geometric', 'torch_geometric.utils', 'torch_geometric.utils.num_nodes', 'torch_geometric.nn',
    'tensorboard', 'sklearn', 'sklearn.metrics', 'einops',
    'polars', 'pandas', 'matplotlib', 'matplotlib.pyplot', 'tqdm',
    'prettytable', 'yaml', 'numpy',
]
